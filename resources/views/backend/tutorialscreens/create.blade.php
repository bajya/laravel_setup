...
@section('title', ucfirst($type).' Tutorial Screen')
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ucfirst($type)}} Tutorial Screen</li>
                </ol>
            </div>
        </div> 
        <!-- Start Page Content -->
                        ...
                        <form class="form-material  row form-valide" method="post" action="{{$url}}" enctype="multipart/form-data">
                            ...
                            {{csrf_field()}}
                                    ...
                                    <div class="form-group col-xxl-3 col-xl-4 col-sm-6">
                                        ...
                                        <div class="">
                                            <div class="input-group">
                                                ...
                                                <input type="file" id="file" required name="tutorialscreen_image" accept=".jpg, .jpeg, .png" class="form-control">
                                            </div>
                                        ...
                                        <div class="">
                                            <div class="input-group">
                                                <div id="image_preview">
                                                    <img height="100" width="100" id="previewing" src="@if($tutorialscreen->image != null){{$tutorialscreen->image}}@endif">
                                                </div>
                                                <input type="file" id="file" name="tutorialscreen_image" accept=".jpg, .jpeg, .png" class="form-control">
                                            </div>
                                            <span class="text-muted">Note: Image should be JPG, JPEG, PNG Dimension 500x500.</span>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group col-xxl-3 col-xl-4 col-sm-6 ">
                                    ...
                                    <input type="text" class="form-control form-control-line" name="tutorialscreen_name" value="{{old('tutorialscreen_name', $tutorialscreen->name)}}" maxlength="100"  placeholder="Please enter title">
                                </div>
                            </div>
                            <input type="hidden" name="status" value="@if(isset($tutorialscreen) && $tutorialscreen->status != null) {{$tutorialscreen->status}} @else active @endif">
                            ...
                            <div class="form-group col-md-12 ">
                                ...
                                <textarea class="form-control form-control-line" name="description" rows="5">{{old('description', $tutorialscreen->description)}}</textarea>
                            </div>
                            
                            <div class="col-12 ">
                                <button type="submit" class="btn btn-success submitBtn m-r-10">Save</button>
                                <a href="{{route('tutorialscreens')}}" class="btn btn-inverse waves-effect waves-light">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5 class="m-t-10 text-danger changeOffer">Are you sure you want to removed Tutorial Screen?.</h5>
